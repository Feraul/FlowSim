function [M,I]=ferncodes_assemblematrixDMP(p,pinterp,gamma,parameter,weightDMP,mobility,graviterm)
...
for iface=1:size(inedge,1)
    ...
    if F2*F1<0 || F2*F1==0
        ...
        [M,I]=ferncodes_auxassemblematrixinteriorDMP1(ifacelef1,M,I,parameter(1,1,ifactual),lef,pinterp,norma,betalef,weightDMP,auxmobility);
        
        ifacelef2=parameter(1,4,ifactual);
        [M,I]=ferncodes_auxassemblematrixinteriorDMP1(ifacelef2,M,I,parameter(1,2,ifactual),lef,pinterp,norma,betalef,weightDMP,auxmobility);
        
        % contribuições do elemento a direita
        
        ifacerel1= parameter(2,3,ifactual);
        [M,I]=ferncodes_auxassemblematrixinteriorDMP1(ifacerel1,M,I,parameter(2,1,ifactual),rel,pinterp,norma,betarel,weightDMP,auxmobility);
        
        ifacerel2= parameter(2,4,ifactual);
        [M,I]=ferncodes_auxassemblematrixinteriorDMP1(ifacerel2,M,I,parameter(2,2,ifactual),rel,pinterp,norma,betarel,weightDMP,auxmobility);
