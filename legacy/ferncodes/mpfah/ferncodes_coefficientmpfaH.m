function [coefficient,auxface]=ferncodes_coefficientmpfaH(F,y,kmap)
...
for ifacont=1:size(bedge,1)
    ...
    if (ksii==1e30 && ksij==1e30) || (ksii>1e10 && ksij>1e10)
        ppp=1;
        [ksii,ksij,aux11,aux12,auxy]=ferncodes_aroundfacelement(F,y,lef,ve2,klef,kmap);
    ...
    [auxface]=ferncodes_calfacelement(lef,ifacont,aux11,aux12,bedge,inedge,auxface,1,2);
...
for iface=1:size(inedge,1)
    ...
    [auxface]=ferncodes_calfacelement(lef,iface+size(bedge,1),aux11,aux12,bedge,inedge,auxface,1,2);
    ...
    [auxface]=ferncodes_calfacelement(rel,iface+size(bedge,1),auxi,auxj,bedge,inedge,auxface,3,4);
