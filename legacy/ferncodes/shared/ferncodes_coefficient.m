    ...
    for i=auxvetor
        if j==length(auxvetor)
            ...
            if ((sign(auxquadrant1(1,3))==sign(auxquadrant2(1,3)) && (abs(auxquadrant1(1,3))>1e-16...
                ...
                if abs(coefficient(1,5,ifacont))<1e-9
                else
    ...
    for i=auxvetor
        if j==length(auxvetor)
            ...
            if ((sign(auxquadrant1(1,3))==sign(auxquadrant2(1,3)) && (abs(auxquadrant1(1,3))>1e-16 ...
                ...
                if abs(coefficient(1,5,iface+size(bedge,1)))<1e-9
                else
    ...
    for ii=auxvetor
        if j==length(auxvetor)
            ...
            if ((sign(auxquadrant1(1,3))==sign(auxquadrant2(1,3)) && (abs(auxquadrant1(1,3))>1e-16 ...
                ...
                if abs(coefficient(2,5,iface+size(bedge,1)))<1e-9
                else
