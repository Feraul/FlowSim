...
% outros parâmetros não definidos no trecho (ajuste conforme seu código)
...
preMPFAD.Kt=Kt;
preMPFAD.Ded=Ded;
preMPFAD.flowrateZ=flowrateZ;
preMPFAD.flowresultZ=flowresultZ;
