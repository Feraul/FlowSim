...
%Calculate the parameters to each element
    ...
    %(boundary free)
    if numcase == 246 || numcase==245 || numcase==247 || numcase==249 || numcase==250
...
%         komax1 = 0.8;
    ...
    %Another examples
        ...
        boolean2nd = (booleanmean + booleanlin + boolean3rd + boolean4th + ...
            boolean5th) == 0; 
        %Get the exponent:
        nw = 4*booleanmean + 2*booleanlin + 3*boolean3rd + 4*boolean4th + ...
            5*boolean5th + 2*boolean2nd; 
        no = 2*booleanmean + 2*booleanlin + boolean3rd + 2*boolean4th + ...
